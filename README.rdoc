...
A handy way to gzip compress response bodies automatically with each request. This was taken from an <em>Agile Web Development with Rails</em> example and extended to allow easy skipping of the compression algorithm.
