...
A handy way to gzip compress response bodies automatically with each request. This was taken from an _Agile Web Development with Rails_ example and extended to allow easy skipping of the compression algorithm.
